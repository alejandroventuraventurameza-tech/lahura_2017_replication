...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{grafico2_ext.png}
  \caption{Tasa de política monetaria y tasas Preferencial a 90 días,
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{grafico2_ext_pre.png}
  \caption{Tasa de política monetaria y tasas Preferencial a 90 días,
...
|       |-- grafico1_ext.png / grafico2_ext.png         
|       |-- grafico1_ext_pre.png / grafico2_ext_pre.png
|       `-- grafico_rolling.png                          
|-- codes/                   
...
|   `-- P2_1_extension_completa.prg     
|-- data/
|   |-- bcrp_series.ipynb                  
|   |-- bcrp_series_p2.py                  
|   |-- tasas_interes_lahura2017.xlsx/.csv
|   |-- tasas_interes_lahura2017_ext.xlsx/.csv
|   |-- tasas_interes_lahura2017.wf1       
|   `-- BCRPData-metadata-*.csv           
|-- ef_metriamacro.pdf        [solo local, no en GitHub]
|-- nota_semanal/             [solo local, no en GitHub]
|-- referencias_pdf/          [solo local, no en GitHub]
|-- .gitignore
`-- README.md                
\end{verbatim}
